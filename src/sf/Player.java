...
public class Player implements Serializable {
	...
	public final Item Body;
	public final Item Hands;
	public final Item Feet;
	public final Item Neck;
	public final Item Belt;
	public final Item Ring;
	public final Item Misc;
	public final Item Weapon;
	public final Item WeaponSecondary;
	...
	public Player(Map<String, Object> data) {
		...
		this.Head = GetItem(data, "item_head");
		this.Body = GetItem(data, "item_body");
		this.Hands = GetItem(data, "item_hand");
		this.Feet = GetItem(data, "item_feet");

		this.Neck = GetItem(data, "item_neck");
		this.Belt = GetItem(data, "item_belt");
		this.Ring = GetItem(data, "item_ring");
		this.Misc = GetItem(data, "item_misc");

		this.Weapon = GetItem(data, "item_wea1");
		this.WeaponSecondary = GetItem(data, "item_wea2");
	...
	private static Item GetItem(Map<String, Object> d, Object key) {
		return (Item) d.get(key);
	}
